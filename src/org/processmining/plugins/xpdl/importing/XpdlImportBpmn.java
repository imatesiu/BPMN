...
@Plugin(name = "Import BPMN model from XPDL 2.1 file", parameterLabels = { "Filename" }, returnLabels = { "BPMN diagram" }, returnTypes = { BPMNDiagram.class })
@UIImportPlugin(description = "XPDL 2.1 files", extensions = { "xpdl" })
