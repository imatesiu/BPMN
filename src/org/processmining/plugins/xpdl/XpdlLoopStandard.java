 ...
 *         <xsd:annotation> <xsd:documentation> This is updated at run time to
 *         count the number of executions of the loop and is available as a
 *         property to be used in expressions. Does this belong in the
 *         XPDL?</xsd:documentation> </xsd:annotation> </xsd:attribute>
 *         <xsd:attribute name="LoopMaximum" type="xsd:integer" use="optional"/>
 *         <xsd:attribute name="TestTime" use="required"> <xsd:simpleType>
 *         <xsd:restriction base="xsd:NMTOKEN"> <xsd:enumeration
 *         value="Before"/> <xsd:enumeration value="After"/> </xsd:restriction>
