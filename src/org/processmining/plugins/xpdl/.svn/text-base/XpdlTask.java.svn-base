 ...
 *         ref="xpdl:TaskReference"> <xsd:annotation> <xsd:documentation>BPMN:
 *         TaskType = Reference. Task properties defined in referenced
 *         activity.</xsd:documentation> </xsd:annotation> </xsd:element>
 *         <xsd:element ref="xpdl:TaskScript"> <xsd:annotation>
 *         <xsd:documentation>BPMN: TaskType = Script. Used for automated tasks
 *         executed by scripts on process engine, to distinguish from automated
 *         tasks performed externally (Service).</xsd:documentation>
 *         </xsd:annotation> </xsd:element> <xsd:element ref="xpdl:TaskSend">
 *         <xsd:annotation> <xsd:documentation>BPMN: Task Type = Send.
 *         Equivalent to a "throwing" message event. Sends a message immediately
 *         and continues. In BPMN, "message" signifies any signal sent outside
 *         the process (pool).</xsd:documentation> </xsd:annotation>
 *         </xsd:element> <xsd:element ref="xpdl:TaskUser"> <xsd:annotation>
 *         <xsd:documentation>BPMN: Task Type = User. Generally used for human
 *         tasks. </xsd:documentation> </xsd:annotation> </xsd:element>
 *         <xsd:element ref="xpdl:TaskApplication"/> </xsd:choice>
