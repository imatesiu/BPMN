 ...
 *         <xsd:enumeration value="None"/> <xsd:enumeration value="Message"/>
 *         <xsd:enumeration value="Error"/> <xsd:enumeration value="Cancel"/>
 *         <xsd:enumeration value="Compensation"/> <xsd:enumeration
 *         value="Signal"/> <xsd:enumeration value="Terminate"/>
 ...
 *         <xsd:annotation> <xsd:documentation> Required if the Trigger or
 *         Result is Message</xsd:documentation> </xsd:annotation>
 *         <xsd:simpleType> <xsd:restriction base="xsd:NMTOKEN">
