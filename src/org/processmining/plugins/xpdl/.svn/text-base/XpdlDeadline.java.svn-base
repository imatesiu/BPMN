 ...
 * @author hverbeek
 * 
 *         <xsd:element name="Deadline"> <xsd:annotation>
 *         <xsd:documentation>BPMN provides a timer event to support this type
 *         of functionality and it is the preferred method for doing
 *         this.</xsd:documentation> </xsd:annotation> <xsd:complexType>
 *         <xsd:sequence> <xsd:element name="DeadlineDuration"
 *         type="xpdl:ExpressionType" minOccurs="0"/> <xsd:element
 *         name="ExceptionName" minOccurs="0"> <xsd:annotation>
 *         <xsd:documentation>This name should match that specified in
 *         Transition/Condition/Expression</xsd:documentation> </xsd:annotation>
 *         <xsd:complexType> <xsd:simpleContent> <xsd:extension
 *         base="xsd:string"> <xsd:anyAttribute namespace="##other"
 *         processContents="lax"/> </xsd:extension> </xsd:simpleContent>
 *         </xsd:complexType> </xsd:element> <xsd:any namespace="##other"
 *         processContents="lax" minOccurs="0" maxOccurs="unbounded"/>
 *         </xsd:sequence> <xsd:attribute name="Execution"> <xsd:simpleType>
 *         <xsd:restriction base="xsd:NMTOKEN"> <xsd:enumeration
 *         value="ASYNCHR"/> <xsd:enumeration value="SYNCHR"/>
