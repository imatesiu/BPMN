 ...
 *         name="MI_Condition" type="xsd:string" use="optional"/> <xsd:attribute
 *         name="LoopCounter" type="xsd:integer"> <xsd:annotation>
 *         <xsd:documentation> This is updated at run time to count the number
 *         of executions of the loop and is available as a property to be used
 *         in expressions. Does this belong in the XPDL?</xsd:documentation>
 *         </xsd:annotation> </xsd:attribute> <xsd:attribute name="MI_Ordering"
 ...
 *         </xsd:attribute> <xsd:attribute name="MI_FlowCondition"
 *         use="optional" default="All"> <xsd:simpleType> <xsd:restriction
 *         base="xsd:NMTOKEN"> <xsd:enumeration value="None"/> <xsd:enumeration
 *         value="One"/> <xsd:enumeration value="All"/> <xsd:enumeration
 *         value="Complex"/> </xsd:restriction> </xsd:simpleType>
 *         </xsd:attribute> <xsd:attribute name="ComplexMI_FlowCondition"
