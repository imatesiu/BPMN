 ...
 *         </xsd:sequence> <xsd:attribute name="ActivityId" type="xpdl:IdRef"
 *         use="required"> <xsd:annotation> <xsd:documentation>BPMN: Reference
 *         to a BPMN task or subprocess definition elsewhere; should not be used
 *         for gateway or event. Pointer to Activity/@Id in
